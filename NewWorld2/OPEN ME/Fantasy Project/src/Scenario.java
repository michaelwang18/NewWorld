...
public class Scenario {
    ...
    public static void afterBattle(Character p1, Character p2, Character p3){
        ...
        if (choice1 == 3 ){
            System.out.println(Color.WHITE_BOLD_BRIGHT + Utility.spaceout("Train" ,24)  + Color.CYAN_BOLD + " +20 Max HP\uD83D\uDC9A  +20 HP\uD83D\uDC9A  +15 DEF\uD83D\uDEE1\uFE0F" + Color.RESET);
        }
        if (choice1 == 4 ){
    ...
    public static void event(Character p1, Character p2, Character p3) {
        ...
        int random = (int) (Math.random() * 4 + 1);   //options
            ...
            case 1:
                ...
                if (choice == 1){  //YES
                    if (lucky){//YES AND LUCK
                        ...
                        System.out.println("Health - 25% of Max Health for " + name);
                        int healing = -(int)Math.round(victim.getMaxHealth() * .25);
            ...
            case 2:
                ...
                if (choice2 == 1){  //YES
                    if (lucky){//YES AND LUCK
                        ...
                        int attackup = (int)Math.round(victim.getATK() * .25);
                        int defense =  (int)Math.round(victim.getDEF() * .25);
                        System.out.println( "25% Attack up for " + name + " and 25% Defense\uD83D\uDC9A");
                        ...
                        System.out.println("-10% defense and -10% attack for " + name);
            ...
            case 3:
                ...
                if (choice3 == 1){  //YES
                    if (lucky){//YES AND LUCK
                        ...
                        System.out.println("-10% health for party\uD83D\uDC9A!" + Color.RESET);
                        for (int i = 0; i < team.length; i++){
                            victim = team[i];
                            int healing = (int)Math.round(victim.getHP() * .1);
                            victim.statChange(-healing,0,0,0);
                            if (victim.getHP() <= 0){
                                victim.setAlive(false);
                            }
                    ...
                    if (lucky) {
                        ...
                        System.out.println(Color.GREEN_BOLD + "-15% Max Hp" + Color.RESET);
                        for (int i = 0; i < team.length; i++) {
                            victim = team[i];
            ...
            case 4:
                ...
                if (choice4 == 1){  //YES
                    if (lucky){//YES AND LUCK
                        ...
                        System.out.println("5% Attack + 5% Defense for party!\nBut -20% HP and Max Hp after starving" + Color.RESET);
                        for (int i = 0; i < team.length; i++){
                            victim = team[i];
                            int healing = (int)Math.round(victim.getHP() * .20);
                            int attackup = (int)Math.round(victim.getATK() * .05);
                            int defense =  (int)Math.round(victim.getDEF() * .05);
                            victim.statChange(-healing,defense,attackup,-healing);
                            if (victim.getHP() <= 0){
                                victim.setAlive(false);
                            }
                        }
                    ...
                    if (lucky) {
                        ...
                        for (int i = 0; i < team.length; i++) {
                            victim = team[i];
                            victim.heal();
                            victim.statChange(0, 0, 0, 20);
                        }
                    } else {
                        System.out.println(Color.WHITE_BRIGHT + "Being woken up by goblins doesn't feel great, especially in the middle of the night");
                        System.out.println("-15% Max Hp for party" + Color.RESET);
                        for (int i = 0; i < team.length; i++) {
                            victim = team[i];
                            victim.heal();
                            int healing = -(int) (victim.getHP() * .15);
                            victim.statChange(healing, 0, 0, healing);
                            if (victim.getHP() <= 0) {
                                victim.setAlive(false);
                            }
